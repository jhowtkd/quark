...
### Active
- [ ] Reports clearly label every data point as realizado, consenso, projeção, or simulação
- [ ] Key financial metrics (revenue, EPS, margins, capex) are validated against public filings before report generation
- [ ] Reports use structured due-diligence format: tese, evidências, fragilidades, premissas, cenários
- [ ] Analytical narrative is audited for confirmation bias and neutrality
- [ ] GAAP and non-GAAP metrics are always distinguished and contextualized
- [ ] Mixed-language output is prevented in generated reports
- [ ] Quantified competitive analysis replaces vague qualitative statements
