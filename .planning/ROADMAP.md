...
- [ ] **Phase 8: Data Provenance and Labeling** — Enforce strict source tagging and transparency for every data point in generated reports.
- [ ] **Phase 9: Data Validation Pipeline** — Build pre-generation validation that cross-checks key financial metrics against public sources.
- [ ] **Phase 10: Structured Report Format** — Implement due-diligence report structure with explicit sections for tese, evidências, fragilidades, premissas e cenários.
- [ ] **Phase 11: Neutrality and Bias Audit** — Add bias detection and neutrality enforcement to analytical narrative generation.
- [ ] **Phase 12: Output Quality Gates** — Implement post-generation checks for language consistency, numeric sanity, and self-contradiction.
...
|-------|----------------|--------|-----------|
| 8. Data Provenance and Labeling | 0/1 | Pending | — |
| 9. Data Validation Pipeline | 0/1 | Pending | — |
| 10. Structured Report Format | 0/1 | Pending | — |
| 11. Neutrality and Bias Audit | 0/1 | Pending | — |
| 12. Output Quality Gates | 0/1 | Pending | — |
