  ...
  <div class="overview-tab">
    ...
    <div class="progress-section">
      ...
      <div class="progress-bar-bg">
        <div class="progress-bar-fill" role="progressbar" :aria-valuenow="state?.progress_percent || 0" aria-valuemin="0" aria-valuemax="100" :style="{ width: (state?.progress_percent || 0) + '%' }"></div>
      </div>
    ...
    <div class="platform-cards">
      <div class="platform-card twitter" :class="{ active: state?.twitter_running, completed: state?.twitter_completed }" :aria-label="`Info Plaza: ${state?.twitter_running ? 'running' : state?.twitter_completed ? 'completed' : 'idle'}`">
        <div class="card-title">
          <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" focusable="false"><circle cx="12" cy="12" r="10"></circle><line x1="2" y1="12" x2="22" y2="12"></line><path d="M12 2a15.3 15.3 0 0 1 4 10 15.3 15.3 0 0 1-4 10 15.3 15.3 0 0 1-4-10 15.3 15.3 0 0 1 4-10z"></path></svg>
      ...
      <div class="platform-card reddit" :class="{ active: state?.reddit_running, completed: state?.reddit_completed }" :aria-label="`Topic Community: ${state?.reddit_running ? 'running' : state?.reddit_completed ? 'completed' : 'idle'}`">
        <div class="card-title">
          <svg viewBox="0 0 24 24" width="14" height="14" fill="none" stroke="currentColor" stroke-width="2" aria-hidden="true" focusable="false"><path d="M21 11.5a8.38 8.38 0 0 1-.9 3.8 8.5 8.5 0 0 1-7.6 4.7 8.38 8.38 0 0 1-3.8-.9L3 21l1.9-5.7a8.38 8.38 0 0 1-.9-3.8 8.5 8.5 0 0 1 4.7-7.6 8.38 8.38 0 0 1 3.8-.9h.5a8.48 8.48 0 0 1 8 8v.5z"></path></svg>
