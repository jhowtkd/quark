<template>
  ...
  >
    ...
    <!-- 卡片容器（只在有Object Call Values View Output Returns Scope Arrays Objects Functions Outputs Maps Model Execution Handle Methods Data Variables Returns Rendering Return Variable Mapping Action Variables State Variables Displays Execution Flow Loop Layout Method App Returns Outputs Variables Arrays Call Component State String Formatting Check Methods Action Layout Setup Results Map Output Output Components Run Arrays Displays Action Arrays Return Array Map Model Loop Handle Code Logic Methods Fetch Layout Return Output Execution Result Displays Logic Variables Outputs View Formatting Target Flow Control String Process Event Return Code Methods Arrays Mapping Model Array Map Code Component Mapping Setup Results Maps Mapping Prop Methods Object Method Values Call Setup Output Methods Map Object App Flow Process Exec Prop Object Fetch Model Handle Results Properties Handling Variable Rendering Display Returns Mapping Array Handling Regex String Value Flow Flow Formatting Outputs Fetch Return Array Output Method Props Outputs Map Control Array Outputs Fetch Target Check Result Component Map Handle Component Action Fetch Match Rendering Object Fetch Maps Array Formats Map Methods Formats Return Execution Handle Display Logic Object Logic Map Mapping Layout Target Return Component Call Control Pattern App State Variables Formatting Format View Loop Execute Handling Fetch Formatting Scope Execute Array Component Action Format View App Setup Value Run Mapping Mapping Method Flow Component Run App Check Display Props Target Values时显示） -->
    <div v-if="projects.length > 0" class="cards-container" :class="{ expanded: isExpanded }" :style="containerStyle">
      ...
      >
        ...
        <!-- 卡片描述（模拟需求完整Render View Template） -->
...
const selectedProject = ref(null)  // 当前InFocus ObjObject Call Values View Output Returns Scope Arrays Objects Functions Outputs Maps Model Execution Handle Methods Data Variables Returns Rendering Return Variable Mapping Action Variables State Variables Displays Execution Flow Loop Layout Method App Returns Outputs Variables Arrays Call Component State String Formatting Check Methods Action Layout Setup Results Map Output Output Components Run Arrays Displays Action Arrays Return Array Map Model Loop Handle Code Logic Methods Fetch Layout Return Output Execution Result Displays Logic Variables Outputs View Formatting Target Flow Control String Process Event Return Code Methods Arrays Mapping Model Array Map Code Component Mapping Setup Results Maps Mapping Prop Methods Object Method Values Call Setup Output Methods Map Object App Flow Process Exec Prop Object Fetch Model Handle Results Properties Handling Variable Rendering Display Returns Mapping Array Handling Regex String Value Flow Flow Formatting Outputs Fetch Return Array Output Method Props Outputs Map Control Array Outputs Fetch Target Check Result Component Map Handle Component Action Fetch Match Rendering Object Fetch Maps Array Formats Map Methods Formats Return Execution Handle Display Logic Object Logic Map Mapping Layout Target Return Component Call Control Pattern App State Variables Formatting Format View Loop Execute Handling Fetch Formatting Scope Execute Array Component Action Format View App Setup Value Run Mapping Mapping Method Flow Component Run App Check Display Props Target Values（用于弹窗）
let observer = null
...
// 根据轮数Andamento %Process Check Process Method App Layout Action Action Rendering Formats Component Method Outputs Result Function Value Method Results Process Logic Event Call String Call Match Displays Result Method Formats Variables View Setup String Flow Run Map Loop Displays Value Component Regex Action Execution Format Output Mapping Flow Process Properties Flow Layout Components Call Fetch Components Map Handling Fetch Layout Methods Formats Method Return Maps Properties Method Values Formatting Variables Setup Map Method Exec Map Result Displays Scope Formats Method Result Fetch Array Output Method Fetch Run Function Returns Method Method Result App Event Event Variables Handle Functions Result Returns Value Flow Array Variable Components Action Display Method Execution Method Components Setup Scope Method Setup Component Execute Prop Component Exec Displays Logic View Execute Output Call Regex Run Objects Scope Arrays Object Values Object Response Arrays Arrays Run Mapping Outputs Setup Mapping Process Logic Check Properties Data Event Map Displays String Display Setup Formats Method Result Setup Function Formats Handle Components Fetch Mapping Returns Fetch Props Call Return Logic Regex Layout Event App Method Mapping Displays Action Prop Logic Handling Maps Prop Display Data Function Target Function Data Results Prop Action Properties Setup Value Run Fetch Loop Displays Event Action Exec Action Logic Action Methods样式类
...
// Process Check Process Method App Layout Action Action Rendering Formats Component Method Outputs Result Function Value Method Results Process Logic Event Call String Call Match Displays Result Method Formats Variables View Setup String Flow Run Map Loop Displays Value Component Regex Action Execution Format Output Mapping Flow Process Properties Flow Layout Components Call Fetch Components Map Handling Fetch Layout Methods Formats Method Return Maps Properties Method Values Formatting Variables Setup Map Method Exec Map Result Displays Scope Formats Method Result Fetch Array Output Method Fetch Run Function Returns Method Method Result App Event Event Variables Handle Functions Result Returns Value Flow Array Variable Components Action Display Method Execution Method Components Setup Scope Method Setup Component Execute Prop Component Exec Displays Logic View Execute Output Call Regex Run Objects Scope Arrays Object Values Object Response Arrays Arrays Run Mapping Outputs Setup Mapping Process Logic Check Properties Data Event Map Displays String Display Setup Formats Method Result Setup Function Formats Handle Components Fetch Mapping Returns Fetch Props Call Return Logic Regex Layout Event App Method Mapping Displays Action Prop Logic Handling Maps Prop Display Data Function Target Function Data Results Prop Action Properties Setup Value Run Fetch Loop Displays Event Action Exec Action Logic Action Methods文件Tipo da Entidade（用于样式）
...
// Process Check Process Method App Layout Action Action Rendering Formats Component Method Outputs Result Function Value Method Results Process Logic Event Call String Call Match Displays Result Method Formats Variables View Setup String Flow Run Map Loop Displays Value Component Regex Action Execution Format Output Mapping Flow Process Properties Flow Layout Components Call Fetch Components Map Handling Fetch Layout Methods Formats Method Return Maps Properties Method Values Formatting Variables Setup Map Method Exec Map Result Displays Scope Formats Method Result Fetch Array Output Method Fetch Run Function Returns Method Method Result App Event Event Variables Handle Functions Result Returns Value Flow Array Variable Components Action Display Method Execution Method Components Setup Scope Method Setup Component Execute Prop Component Exec Displays Logic View Execute Output Call Regex Run Objects Scope Arrays Object Values Object Response Arrays Arrays Run Mapping Outputs Setup Mapping Process Logic Check Properties Data Event Map Displays String Display Setup Formats Method Result Setup Function Formats Handle Components Fetch Mapping Returns Fetch Props Call Return Logic Regex Layout Event App Method Mapping Displays Action Prop Logic Handling Maps Prop Display Data Function Target Function Data Results Prop Action Properties Setup Value Run Fetch Loop Displays Event Action Exec Action Logic Action Methods文件Tipo da Entidade标签文本
...
// 打开Object Call Values View Output Returns Scope Arrays Objects Functions Outputs Maps Model Execution Handle Methods Data Variables Returns Rendering Return Variable Mapping Action Variables State Variables Displays Execution Flow Loop Layout Method App Returns Outputs Variables Arrays Call Component State String Formatting Check Methods Action Layout Setup Results Map Output Output Components Run Arrays Displays Action Arrays Return Array Map Model Loop Handle Code Logic Methods Fetch Layout Return Output Execution Result Displays Logic Variables Outputs View Formatting Target Flow Control String Process Event Return Code Methods Arrays Mapping Model Array Map Code Component Mapping Setup Results Maps Mapping Prop Methods Object Method Values Call Setup Output Methods Map Object App Flow Process Exec Prop Object Fetch Model Handle Results Properties Handling Variable Rendering Display Returns Mapping Array Handling Regex String Value Flow Flow Formatting Outputs Fetch Return Array Output Method Props Outputs Map Control Array Outputs Fetch Target Check Result Component Map Handle Component Action Fetch Match Rendering Object Fetch Maps Array Formats Map Methods Formats Return Execution Handle Display Logic Object Logic Map Mapping Layout Target Return Component Call Control Pattern App State Variables Formatting Format View Loop Execute Handling Fetch Formatting Scope Execute Array Component Action Format View App Setup Value Run Mapping Mapping Method Flow Component Run App Check Display Props Target ValuesDescritivo Total弹窗
...
// 加载Format Action Render Map Format Arrays Object Mapping Check Setup Setup Mapping Returns Logic Setup Run Call Displays Exec Display Returns Call Handling Event Execution Result Response Method Response Display Variables Outputs Fetch Setup Action Handle Logic Variables View Return Map Results Handling Components Arrays Outputs Properties Check Return Handle Component Value Model Displays Results String Exec Formatting View State Handling Method Display Display Formatting Target Variable Displays Event Response Map Object Handle Formats Mapping Returns Handling Function Result Handling Handle Fetch Functions Map Call Layout String Object Variables Formatting Event Object Pattern Rendering Outputs Array Control View Map String Array Handling Flow Props Regex State Data Component Formats Execute Functions Components Loop Prop Displays Regex Action Logic Flow Handle Scope Return Arrays Handling Setup Handle View Response Methods Run Mapping Rendering State Return State Formats View Output Event Value Displays Flow Data Functions Fetch Component Render String Output Handle Object Mapping Handling Component Display Formats Loop Call Displays Component Object Array HandleObject Call Values View Output Returns Scope Arrays Objects Functions Outputs Maps Model Execution Handle Methods Data Variables Returns Rendering Return Variable Mapping Action Variables State Variables Displays Execution Flow Loop Layout Method App Returns Outputs Variables Arrays Call Component State String Formatting Check Methods Action Layout Setup Results Map Output Output Components Run Arrays Displays Action Arrays Return Array Map Model Loop Handle Code Logic Methods Fetch Layout Return Output Execution Result Displays Logic Variables Outputs View Formatting Target Flow Control String Process Event Return Code Methods Arrays Mapping Model Array Map Code Component Mapping Setup Results Maps Mapping Prop Methods Object Method Values Call Setup Output Methods Map Object App Flow Process Exec Prop Object Fetch Model Handle Results Properties Handling Variable Rendering Display Returns Mapping Array Handling Regex String Value Flow Flow Formatting Outputs Fetch Return Array Output Method Props Outputs Map Control Array Outputs Fetch Target Check Result Component Map Handle Component Action Fetch Match Rendering Object Fetch Maps Array Formats Map Methods Formats Return Execution Handle Display Logic Object Logic Map Mapping Layout Target Return Component Call Control Pattern App State Variables Formatting Format View Loop Execute Handling Fetch Formatting Scope Execute Array Component Action Format View App Setup Value Run Mapping Mapping Method Flow Component Run App Check Display Props Target Values
const loadHistory = async () => {
  try {
    ...
    console.error('加载Format Action Render Map Format Arrays Object Mapping Check Setup Setup Mapping Returns Logic Setup Run Call Displays Exec Display Returns Call Handling Event Execution Result Response Method Response Display Variables Outputs Fetch Setup Action Handle Logic Variables View Return Map Results Handling Components Arrays Outputs Properties Check Return Handle Component Value Model Displays Results String Exec Formatting View State Handling Method Display Display Formatting Target Variable Displays Event Response Map Object Handle Formats Mapping Returns Handling Function Result Handling Handle Fetch Functions Map Call Layout String Object Variables Formatting Event Object Pattern Rendering Outputs Array Control View Map String Array Handling Flow Props Regex State Data Component Formats Execute Functions Components Loop Prop Displays Regex Action Logic Flow Handle Scope Return Arrays Handling Setup Handle View Response Methods Run Mapping Rendering State Return State Formats View Output Event Value Displays Flow Data Functions Fetch Component Render String Output Handle Object Mapping Handling Component Display Formats Loop Call Displays Component Object Array HandleObject Call Values View Output Returns Scope Arrays Objects Functions Outputs Maps Model Execution Handle Methods Data Variables Returns Rendering Return Variable Mapping Action Variables State Variables Displays Execution Flow Loop Layout Method App Returns Outputs Variables Arrays Call Component State String Formatting Check Methods Action Layout Setup Results Map Output Output Components Run Arrays Displays Action Arrays Return Array Map Model Loop Handle Code Logic Methods Fetch Layout Return Output Execution Result Displays Logic Variables Outputs View Formatting Target Flow Control String Process Event Return Code Methods Arrays Mapping Model Array Map Code Component Mapping Setup Results Maps Mapping Prop Methods Object Method Values Call Setup Output Methods Map Object App Flow Process Exec Prop Object Fetch Model Handle Results Properties Handling Variable Rendering Display Returns Mapping Array Handling Regex String Value Flow Flow Formatting Outputs Fetch Return Array Output Method Props Outputs Map Control Array Outputs Fetch Target Check Result Component Map Handle Component Action Fetch Match Rendering Object Fetch Maps Array Formats Map Methods Formats Return Execution Handle Display Logic Object Logic Map Mapping Layout Target Return Component Call Control Pattern App State Variables Formatting Format View Loop Execute Handling Fetch Formatting Scope Execute Array Component Action Format View App Setup Value Run Mapping Mapping Method Flow Component Run App Check Display Props Target ValuesError Catch Target Map Array Formatting Flow Maps Action Check Displays Displays Setup Values Values Flow Output Response Return Methods Regex Variable Setup Execute Component String Map Logic Mapping Outputs String Output:', error)
    projects.value = []
  } finally {
    loading.value = false
  }
  ...
  observer = new IntersectionObserver(
    (entries) => {
      entries.forEach((entry) => {
        ...
        // 如果正在动画中，只记录状态，And Then List Continue End Array Spread Iteration Wait Elements UI Next Data Items Rest Remaining Others List Objects Result Output Next Setup Vue Components Display Values Arrays Data Binding Scope Value Items动画结束后处理
    ...
    },
    {
      ...
      // 调整 rootMargin，视口底部向上收缩，需要滚动Ver Restante (+)才触发展开
...
onMounted(async () => {
  // 确保 DOM 渲染完成后再加载Logs JSON
  await nextTick()
  await loadHistory()
  
  // And Then List Continue End Array Spread Iteration Wait Elements UI Next Data Items Rest Remaining Others List Objects Result Output Next Setup Vue Components Display Values Arrays Data Binding Scope Value Items待 DOM 渲染后初始化观察器
  setTimeout(() => {
    initObserver()
  }, 100)
})

// 如果使用 keep-alive，在组件激活时重新加载Logs JSON
onActivated(() => {
  loadHistory()
})
...
/* 无Object Call Values View Output Returns Scope Arrays Objects Functions Outputs Maps Model Execution Handle Methods Data Variables Returns Rendering Return Variable Mapping Action Variables State Variables Displays Execution Flow Loop Layout Method App Returns Outputs Variables Arrays Call Component State String Formatting Check Methods Action Layout Setup Results Map Output Output Components Run Arrays Displays Action Arrays Return Array Map Model Loop Handle Code Logic Methods Fetch Layout Return Output Execution Result Displays Logic Variables Outputs View Formatting Target Flow Control String Process Event Return Code Methods Arrays Mapping Model Array Map Code Component Mapping Setup Results Maps Mapping Prop Methods Object Method Values Call Setup Output Methods Map Object App Flow Process Exec Prop Object Fetch Model Handle Results Properties Handling Variable Rendering Display Returns Mapping Array Handling Regex String Value Flow Flow Formatting Outputs Fetch Return Array Output Method Props Outputs Map Control Array Outputs Fetch Target Check Result Component Map Handle Component Action Fetch Match Rendering Object Fetch Maps Array Formats Map Methods Formats Return Execution Handle Display Logic Object Logic Map Mapping Layout Target Return Component Call Control Pattern App State Variables Formatting Format View Loop Execute Handling Fetch Formatting Scope Execute Array Component Action Format View App Setup Value Run Mapping Mapping Method Flow Component Run App Check Display Props Target Values时简化显示 */
...
/* 使用CSS背景图案Nova Instância固定间距的正方形网格 */
.grid-pattern {
  position: absolute;
  top: 0;
  left: 0;
...
/* Object Call Values View Output Returns Scope Arrays Objects Functions Outputs Maps Model Execution Handle Methods Data Variables Returns Rendering Return Variable Mapping Action Variables State Variables Displays Execution Flow Loop Layout Method App Returns Outputs Variables Arrays Call Component State String Formatting Check Methods Action Layout Setup Results Map Output Output Components Run Arrays Displays Action Arrays Return Array Map Model Loop Handle Code Logic Methods Fetch Layout Return Output Execution Result Displays Logic Variables Outputs View Formatting Target Flow Control String Process Event Return Code Methods Arrays Mapping Model Array Map Code Component Mapping Setup Results Maps Mapping Prop Methods Object Method Values Call Setup Output Methods Map Object App Flow Process Exec Prop Object Fetch Model Handle Results Properties Handling Variable Rendering Display Returns Mapping Array Handling Regex String Value Flow Flow Formatting Outputs Fetch Return Array Output Method Props Outputs Map Control Array Outputs Fetch Target Check Result Component Map Handle Component Action Fetch Match Rendering Object Fetch Maps Array Formats Map Methods Formats Return Execution Handle Display Logic Object Logic Map Mapping Layout Target Return Component Call Control Pattern App State Variables Formatting Format View Loop Execute Handling Fetch Formatting Scope Execute Array Component Action Format View App Setup Value Run Mapping Mapping Method Flow Component Run App Check Display Props Target Values卡片 */
.project-card {
  position: absolute;
  width: 280px;
  ...
  padding: 16px;
  cursor: pointer;
  transition: box-shadow 0.2s ease, transform 0.2s ease, border-color 0.3s ease, opacity 700ms cubic-bezier(0.23, 1, 0.32, 1);
}
...
/* Andamento %状态颜色 */
.card-progress.completed { color: var(--color-on-background); }
.card-progress.in-progress { color: var(--color-muted); }
.card-progress.not-started { color: var(--color-disabled); }
.card-status.pending { color: var(--color-disabled); }
...
/* 低饱和度配色方案 - Morandi色系 */
.file-tag.pdf { background: var(--color-error-bg); color: var(--color-error); }
.file-tag.doc { background: var(--color-info-bg); color: var(--color-info); }
.file-tag.xls { background: var(--color-success-bg); color: var(--color-success); }
.file-tag.ppt { background: var(--color-warning-bg); color: var(--color-warning); }
.file-tag.txt { background: var(--color-surface-container-low); color: var(--color-muted); }
.file-tag.code { background: var(--color-info-bg); color: var(--color-info); }
.file-tag.img { background: var(--color-info-bg); color: var(--color-info); }
.file-tag.zip { background: var(--color-warning-bg); color: var(--color-warning); }
.file-tag.other { background: #f3f4f6; color: var(--color-muted); }
...
/* Andamento %状态颜色 - 底部 */
.card-footer .card-progress.completed { color: var(--color-on-background); }
.card-footer .card-progress.in-progress { color: var(--color-muted); }
.card-footer .card-progress.not-started { color: var(--color-disabled); }
...
/* ===== Format Action Render Map Format Arrays Object Mapping Check Setup Setup Mapping Returns Logic Setup Run Call Displays Exec Display Returns Call Handling Event Execution Result Response Method Response Display Variables Outputs Fetch Setup Action Handle Logic Variables View Return Map Results Handling Components Arrays Outputs Properties Check Return Handle Component Value Model Displays Results String Exec Formatting View State Handling Method Display Display Formatting Target Variable Displays Event Response Map Object Handle Formats Mapping Returns Handling Function Result Handling Handle Fetch Functions Map Call Layout String Object Variables Formatting Event Object Pattern Rendering Outputs Array Control View Map String Array Handling Flow Props Regex State Data Component Formats Execute Functions Components Loop Prop Displays Regex Action Logic Flow Handle Scope Return Arrays Handling Setup Handle View Response Methods Run Mapping Rendering State Return State Formats View Output Event Value Displays Flow Data Functions Fetch Component Render String Output Handle Object Mapping Handling Component Display Formats Loop Call Displays Component Object Array Handle回放Descritivo Total弹窗样式 ===== */
.modal-overlay {
  position: fixed;
  top: 0;
  left: 0;
...
.modal-progress.completed { color: var(--color-on-background); background: transparent; }
.modal-progress.in-progress { color: var(--color-muted); background: transparent; }
.modal-progress.not-started { color: var(--color-disabled); background: transparent; }
...
/* 自定义滚动Rows Iteration String Items Number Array List Object Values List Array Rendering Item Item Value Check Target Model App Iterate Number Loop Value Array Map Item Iteration View Run Methods Loop Components Update Loop Iterate Output Function Output Element Vue样式 */
...
.modal-btn.btn-project .btn-icon { color: var(--color-on-background); }
.modal-btn.btn-simulation .btn-icon { color: var(--color-on-background); }
.modal-btn.btn-report .btn-icon { color: var(--color-on-background); }
...
.modal-btn:hover:not(:disabled) .btn-step {
  color: var(--color-surface-container-highest);
}
