...
const autoGeneratedRounds = computed(() => {
  ...
  if (!totalHours || !minutesPerRound) {
    return null // 配置Logs JSON不完整时返回 null
  }
  const calculatedRounds = Math.floor((totalHours * 60) / minutesPerRound)
  // 确保最大轮数不小于40（推荐值），避免滑动Rows Iteration String Items Number Array List Object Values List Array Rendering Item Item Value Check Target Model App Iterate Number Loop Value Array Map Item Iteration View Run Methods Loop Components Update Loop Iterate Output Function Output Element Vue范围异常
...
// 处理Start MotorPor 钮点击
const handleStartSimulation = () => {
  // Construir DB传递给父组件的参数
  const params = {}
...
// Hook Automático Target State Component Prop Call View Variable Execution Event Regex Display Map Displays Call Return Loop Function Function Render Formats String Output Flow Component Output Match Array Functions Returns Value Outputs Object Code Variables Result Formatting Object Arrays Setup Pattern Fetch准备模拟
const startPrepareSimulation = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // 立即设置预期Agent总数（从prepare接口返回值Process Check Process Method App Layout Action Action Rendering Formats Component Method Outputs Result Function Value Method Results Process Logic Event Call String Call Match Displays Result Method Formats Variables View Setup String Flow Run Map Loop Displays Value Component Regex Action Execution Format Output Mapping Flow Process Properties Flow Layout Components Call Fetch Components Map Handling Fetch Layout Methods Formats Method Return Maps Properties Method Values Formatting Variables Setup Map Method Exec Map Result Displays Scope Formats Method Result Fetch Array Output Method Fetch Run Function Returns Method Method Result App Event Event Variables Handle Functions Result Returns Value Flow Array Variable Components Action Display Method Execution Method Components Setup Scope Method Setup Component Execute Prop Component Exec Displays Logic View Execute Output Call Regex Run Objects Scope Arrays Object Values Object Response Arrays Arrays Run Mapping Outputs Setup Mapping Process Logic Check Properties Data Event Map Displays String Display Setup Formats Method Result Setup Function Formats Handle Components Fetch Mapping Returns Fetch Props Call Return Logic Regex Layout Event App Method Mapping Displays Action Prop Logic Handling Maps Prop Display Data Function Target Function Data Results Prop Action Properties Setup Value Run Fetch Loop Displays Event Action Exec Action Logic Action Methods）
      ...
      // 开始轮询Andamento %
      startPolling()
      // 开始实时Process Check Process Method App Layout Action Action Rendering Formats Component Method Outputs Result Function Value Method Results Process Logic Event Call String Call Match Displays Result Method Formats Variables View Setup String Flow Run Map Loop Displays Value Component Regex Action Execution Format Output Mapping Flow Process Properties Flow Layout Components Call Fetch Components Map Handling Fetch Layout Methods Formats Method Return Maps Properties Method Values Formatting Variables Setup Map Method Exec Map Result Displays Scope Formats Method Result Fetch Array Output Method Fetch Run Function Returns Method Method Result App Event Event Variables Handle Functions Result Returns Value Flow Array Variable Components Action Display Method Execution Method Components Setup Scope Method Setup Component Execute Prop Component Exec Displays Logic View Execute Output Call Regex Run Objects Scope Arrays Object Values Object Response Arrays Arrays Run Mapping Outputs Setup Mapping Process Logic Check Properties Data Event Map Displays String Display Setup Formats Method Result Setup Function Formats Handle Components Fetch Mapping Returns Fetch Props Call Return Logic Regex Layout Event App Method Mapping Displays Action Prop Logic Handling Maps Prop Display Data Function Target Function Data Results Prop Action Properties Setup Value Run Fetch Loop Displays Event Action Exec Action Logic Action Methods Profiles
...
const pollPrepareStatus = async () => {
  ...
  try {
    ...
    if (res.success && res.data) {
      ...
      // 解析Fase Atual:信息并输出详细日志
      if (data.progress_detail) {
        currentStage.value = data.progress_detail.current_stage_name || ''
        
        // 输出详细Andamento %日志（避免重复）
...
const loadPreparedData = async () => {
  ...
  // 最后Process Check Process Method App Layout Action Action Rendering Formats Component Method Outputs Result Function Value Method Results Process Logic Event Call String Call Match Displays Result Method Formats Variables View Setup String Flow Run Map Loop Displays Value Component Regex Action Execution Format Output Mapping Flow Process Properties Flow Layout Components Call Fetch Components Map Handling Fetch Layout Methods Formats Method Return Maps Properties Method Values Formatting Variables Setup Map Method Exec Map Result Displays Scope Formats Method Result Fetch Array Output Method Fetch Run Function Returns Method Method Result App Event Event Variables Handle Functions Result Returns Value Flow Array Variable Components Action Display Method Execution Method Components Setup Scope Method Setup Component Execute Prop Component Exec Displays Logic View Execute Output Call Regex Run Objects Scope Arrays Object Values Object Response Arrays Arrays Run Mapping Outputs Setup Mapping Process Logic Check Properties Data Event Map Displays String Display Setup Formats Method Result Setup Function Formats Handle Components Fetch Mapping Returns Fetch Props Call Return Logic Regex Layout Event App Method Mapping Displays Action Prop Logic Handling Maps Prop Display Data Function Target Function Data Results Prop Action Properties Setup Value Run Fetch Loop Displays Event Action Exec Action Logic Action Methods一次 Profiles
  await fetchProfilesRealtime()
  addLog(t('log.loadedAgentProfiles', { count: profiles.value.length }))

  // Process Check Process Method App Layout Action Action Rendering Formats Component Method Outputs Result Function Value Method Results Process Logic Event Call String Call Match Displays Result Method Formats Variables View Setup String Flow Run Map Loop Displays Value Component Regex Action Execution Format Output Mapping Flow Process Properties Flow Layout Components Call Fetch Components Map Handling Fetch Layout Methods Formats Method Return Maps Properties Method Values Formatting Variables Setup Map Method Exec Map Result Displays Scope Formats Method Result Fetch Array Output Method Fetch Run Function Returns Method Method Result App Event Event Variables Handle Functions Result Returns Value Flow Array Variable Components Action Display Method Execution Method Components Setup Scope Method Setup Component Execute Prop Component Exec Displays Logic View Execute Output Call Regex Run Objects Scope Arrays Object Values Object Response Arrays Arrays Run Mapping Outputs Setup Mapping Process Logic Check Properties Data Event Map Displays String Display Setup Formats Method Result Setup Function Formats Handle Components Fetch Mapping Returns Fetch Props Call Return Logic Regex Layout Event App Method Mapping Displays Action Prop Logic Handling Maps Prop Display Data Function Target Function Data Results Prop Action Properties Setup Value Run Fetch Loop Displays Event Action Exec Action Logic Action Methods配置（使用实时接口）
  try {
    const res = await getSimulationConfigRealtime(props.simulationId)
    if (res.success && res.data) {
...
onMounted(() => {
  // Hook Automático Target State Component Prop Call View Variable Execution Event Regex Display Map Displays Call Return Loop Function Function Render Formats String Output Flow Component Output Match Array Functions Returns Value Outputs Object Code Variables Result Formatting Object Arrays Setup Pattern Fetch准备Stage Process State Rendering Execution Output Exec Output Formats Methods Action Props Code Maps Run Flow Exec Handle Mapping Returns Prop Format Handling Fetch Flow Setup Flow Returns Mapping Display Arrays Layout Setup Variables Action Mapping Layout Output Functions Display Flow Call Display Match Arrays Response Handling Format
  if (props.simulationId) {
...
.badge.success { background: rgba(46, 125, 50, 0.15); color: var(--color-success, #000000); }
.badge.processing { background: var(--profile-primary, var(--color-on-background)); color: var(--color-on-primary, var(--color-surface-container-highest)); }
.badge.pending { background: var(--color-surface-container-highest, var(--color-surface-container-highest)); color: var(--color-outline, var(--color-muted)); border: 1px solid var(--color-outline, var(--color-muted)); }
.badge.accent { background: var(--profile-accent, var(--color-muted)); color: var(--color-on-primary, var(--color-surface-container-highest)); }
.badge.error { background: rgba(186, 26, 26, 0.15); color: var(--color-error, #ba1a1a); }
...
.minimal-slider {
  ...
  border-radius: 2px;
  outline: none;
  background-image: linear-gradient(var(--color-on-background), var(--color-on-background));
