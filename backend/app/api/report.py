...
def generate_report():
    ...
    try:
        ...
        agent_evolution = ctx.get("agent_evolution", {})
        spawn_limited_thread(
            ReportOrchestratorService.start_report_generation,
            args=(simulation_id, report_id, task_id, graph_id, simulation_requirement, profile, current_locale, agent_evolution)
        )
...
def retry_section(report_id: str):
    ...
    try:
        ...
        spawn_limited_thread(_retry_section_thread)
